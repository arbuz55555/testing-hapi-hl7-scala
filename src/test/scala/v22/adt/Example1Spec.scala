...
class Example1Spec extends Specification {
  ...
  "ADT message" should {
    "has ADT type A01 and Patient with familyName 'SMITH'" in {
      ...
      msgType mustEqual "ADT"
      msgTrigger mustEqual "A01"

      val patientName:PN = adtMsg.getPID.getPatientName()
      val familyName = patientName.getFamilyName()
      familyName.toString mustEqual "SMITH"
    }
  }
}